...
public:
    ...
    void setupUi(QWidget *QtADBClass)
    {
        ...
        QtADBClass->resize(1000, 1000);
        gridLayout_8 = new QGridLayout(QtADBClass);
        ...
        textEdit_jg = new QTextEdit(groupBox_5);
        textEdit_jg->setObjectName(QString::fromUtf8("textEdit_jg"));
        QSizePolicy sizePolicy1(QSizePolicy::Expanding, QSizePolicy::Expanding);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(textEdit_jg->sizePolicy().hasHeightForWidth());
        textEdit_jg->setSizePolicy(sizePolicy1);
        textEdit_jg->setMinimumSize(QSize(0, 0));

        gridLayout_6->addWidget(textEdit_jg, 0, 0, 1, 1);


        gridLayout_4->addWidget(groupBox_5, 3, 0, 1, 2);
        ...
        gridLayout_4->addWidget(groupBox, 0, 0, 2, 2);
        ...
        gridLayout_5->addWidget(pushButton_refresh_2, 2, 1, 1, 1);
        ...
        textEdit_ml = new QTextEdit(groupBox_4);
        textEdit_ml->setObjectName(QString::fromUtf8("textEdit_ml"));
        sizePolicy1.setHeightForWidth(textEdit_ml->sizePolicy().hasHeightForWidth());
        textEdit_ml->setSizePolicy(sizePolicy1);
        textEdit_ml->setMinimumSize(QSize(0, 0));

        gridLayout_3->addWidget(textEdit_ml, 1, 0, 1, 1);
    ...
    void retranslateUi(QWidget *QtADBClass)
    {
        ...
        groupBox_5->setTitle(QApplication::translate("QtADBClass", "\347\273\223\346\236\234", nullptr));
